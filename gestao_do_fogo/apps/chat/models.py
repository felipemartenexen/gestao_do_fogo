...
def get_agent_type_choices() -> list[tuple[str, str]]:
    ...
    # mypy can't follow the functional TextChoices API
    return models.TextChoices("AgentType", " ".join(AgentTypes)).choices  # type: ignore[attr-defined]
