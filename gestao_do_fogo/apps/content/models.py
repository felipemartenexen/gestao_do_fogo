...
def _get_default_block_types() -> list[tuple[str, Any]]:
    return [
...
class BaseContentPage(Page):
    ...
    def get_social_image_url(self) -> str:
...
class BlogIndexPage(BaseContentPage):
    ...
    def get_ordered_blog_posts(self) -> models.QuerySet:
...
class BlogPageGalleryImage(Orderable):
    ...
    image: models.ForeignKey = models.ForeignKey("wagtailimages.Image", on_delete=models.CASCADE, related_name="+")
