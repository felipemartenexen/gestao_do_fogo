...
websocket_reverse = partial(reverse, urlconf="gestao_do_fogo.channels_urls")


def websocket_absolute_url(relative_url: str, is_secure: bool = settings.USE_HTTPS_IN_ABSOLUTE_URLS) -> str:
    """
    Returns the complete absolute url for a given path - for use in emails or API integrations.
    """
